 ...
 */
class Configuration extends AbstractClass implements \ArrayAccess
{
    /**
     * The package key
     *
    ...
    protected array $setup = []; // The TS setup
    ...
    public function __construct()
    {
        ...
        $this->setup = $this->request->getAttribute('frontend.typoscript')->getSetupArray()['plugin.'][$this->getPrefixedPackageKey() . '.'];
